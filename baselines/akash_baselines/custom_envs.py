...
from agents import Person, DeterministicFunctionPerson
...
class BehavSimEnv(gym.Env):
    ...
    def __init__(self, action_space_string="continuous", one_day=False, energy_in_state=False, response='t'):
